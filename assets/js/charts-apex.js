...
// Horizontal Bar Chart2
  ...
  // Donut Chart2
  // --------------------------------------------------------------------
  const donutChartEle = document.querySelector('#donutCharte'),
    donutChartConfige = {
      chart: {
        height: 390,
        type: 'donut'
  ...
  if (typeof donutChartEle !== undefined && donutChartEle !== null) {
    const donutCharte = new ApexCharts(donutChartEle, donutChartConfige);
    donutCharte.render();
  }
})();
